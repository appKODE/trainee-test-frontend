...
7. По завершению работ, добавь в [readme.md](http://readme.md) реальное время выполнение задач и напиши в телеграм о готовности [@ekaterina_sergeeva1_en](https://t.me/ekaterina_sergeeva1_en), чтобы задание начали проверять.
