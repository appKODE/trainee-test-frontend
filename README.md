...
7. По завершению работ, добавь в `readme.md` реальное время выполнение задач и отправляй в ссылку на гитхаб к нам в бот [https://t.me/kodeFrontendBot](https://t.me/kodeFrontendBot)
